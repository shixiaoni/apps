...
class All1 extends Component {
    constructor(props) {
        ...
        render(){
            ...
            return (
                <div className="root-div" onScroll={this.changeScroll} ref="container">
                    <Header grade={{...this.state.data.grade,...this.state.data.period}} courseList={this.state.data.courseList} click={this.click} img={this.props.location.pathname=="/student/repos"?hhhhh:cccc}/>
                    <div id="box">
                        {
                            children
                        }
                        <Leftc students={this.state.data.students} changeIndex={this.changeIndex} clickedStudent={this.state.index} set={this.state.set}
                               pathname={this.props.location.pathname}/>
                    </div>
                    {
                        this.props.location.pathname=="/student/repos"?<Pop flag={this.state.flag} cancelMask={this.cancelMask}  reward={this.state.data.rewards[this.state.num]} changeScore={this.changeScore}/>:<Popt flag={this.state.flag} cancelMask={this.cancelMask} students={this.state.data.students[this.state.index]} students={this.state.data.students}/>
                    }
                </div>
