...
import chahao from '../students4/images/yuan_11.png';
...
class Right3 extends Component {
    ...
    render() {
        ...
        return (
            <div className="jfjl">
                <div className="jfjl-right">
                    <p>{`${new Date().getYear() + 1900}年${new Date().getMonth() + 1}月${new Date().getDate()}日`}</p>
                    {
                        this.state.oparateRecord.todayArr.map((obj,index)=>{
                                return(
                                <ul className="right-2" key={index}>
                                    <li>
                                        <div className="right-2-1-top" >
                                            ...
                                            <div className="yyyyy" >
                                                <img src={chahao} alt="" onClick={()=>this.del(obj,index)}/>
                                            </div>
                                        </div>
                                    </li>
                                </ul>
